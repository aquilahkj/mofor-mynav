...
import 'package:mynav/modules/order/pages/order_list_page.dart';
import 'package:mynav/modules/order/providers/order_page_provider.dart';
...
import 'package:mynav/utils/screen_utils.dart';
import 'package:mynav/utils/theme_utils.dart';
import 'package:mynav/widgets/load_image.dart';
import 'package:mynav/widgets/my_card.dart';
import 'package:mynav/widgets/my_flexible_space_bar.dart';
import 'package:provider/provider.dart';

import 'package:mynav/modules/order/order_router.dart';
        ...
        delegate: SliverAppBarDelegate(
            DecoratedBox(
              decoration: BoxDecoration(
                  ...
                  image: isDark
                      ? null
                      : DecorationImage(image: ImageUtils.getAssetImage('order/order_bg1'), fit: BoxFit.fill)),
              child: Padding(
