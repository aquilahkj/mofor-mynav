...
import 'package:mynav/modules/order/widgets/pay_type_dialog.dart';
                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      ...
                      Text(
                        '货到付款',
                        style: TextStyle(fontSize: Dimens.font_sp12, color: Theme.of(context).errorColor),
                      ),
                    ],
                  ),
                  Gaps.vGap8,
                      ...
                      Expanded(
                        child: RichText(
                          ...
                          children: <TextSpan>[
                            ...
                            TextSpan(
                                text: '  共3件商品',
                                style: Theme.of(context).textTheme.subtitle2.copyWith(fontSize: Dimens.font_sp10)),
                          ],
                        )),
                      ),
                      Text(
...
class OrderItemButton extends StatelessWidget {
  const OrderItemButton({Key key, this.bgColor, this.textColor, this.text, this.onTap}) : super(key: key);
